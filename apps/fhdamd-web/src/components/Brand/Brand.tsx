...
export function LogoMark({ height = 28, variant = "ink" }: LogoMarkProps) {
  return (
    <svg
      ...
      height={height}
      style={{ width: "auto", fill: "currentColor", opacity: variant === "faint" ? 0.32 : 1 }}
    >
      {LOGO_PATHS.map((d) => (
...
export function BrandWordmark({ variant = "ink" }: { variant?: "ink" | "faint" }) {
  return (
    <span style={{ display: "inline-flex", alignItems: "center", gap: 10, color: "var(--th-color-text-1)" }}>
