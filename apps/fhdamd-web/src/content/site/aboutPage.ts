...
export const aboutPage: AboutPage = {
  ...
  bio: [
    ...
    "Outside of EY I'm a builder. <b>Jamaal</b> is a calm iOS focus app I'm developing in Swift, built on a deterministic rules engine I designed from scratch. <b>PDF-Craft</b> is a pay-per-use SaaS product. <b>Threads</b> is the design system underlying everything — one token set that works across iOS, macOS, and web. None of these exist because they were good business ideas. They exist because I couldn't find what I needed and decided to build it.",
    "I'm based in Melbourne, educated at Monash and Jamia Millia Islamia in New Delhi. I write occasionally about product decisions, engineering tradeoffs, and building in the margins of a demanding career.",
  ],
