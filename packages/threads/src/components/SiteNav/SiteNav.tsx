...
export interface SiteNavProps {
  site?: SiteVariant;
  links?: NavLink[];
  /** One or two CTAs rendered in the nav actions area. */
  ctas?: NavCta[];
  homeHref?: string;
  className?: string;
}
...
/**
 * The fhdamd geometric mark — 5-path logo, fill via currentColor.
 * viewBox "8 14 58 66" crops blank canvas padding from the full 128×128 grid.
 */
function FhdamdMark() {
  return (
    <svg
