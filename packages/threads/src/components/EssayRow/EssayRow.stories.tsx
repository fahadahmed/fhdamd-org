...
export const WritingList: Story = {
  ...
  render: () => (
    <div>
      ...
      <EssayRow       date="Apr 2026" title="Pay-per-use is underrated for small SaaS" subtitle="What building Riqa taught me about pricing models"                        category="product" href="#" />
